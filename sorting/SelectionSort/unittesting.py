...
class TestSelectionSort(unittest.TestCase):
    """
    I'm testing my implementation of Selection Sort Algorithm with Python's built-in sorting algorithm.
    """
    ...
    def test_mixed_integers(self):
        my_list = SelectionSort([5, 1, 10, 0, -2, 11, -3, 2, -100, 61, -176743, 163, -176742, 9])
